...
3. Modelar um diagrama de classes do sistema desenvolvido (entregar em papel);

4. Criar um pull-request a partir do _branch psoft-avt1_ para o _branch main_ (principal);
