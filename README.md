...
3. Modelar um diagrama de classes do sistema desenvolvido e adicionar ao repositório em formato pdf (também entregar em papel);

4. Criar um pull-request a partir do _branch psoft-avt1_ para o _branch master_ (principal);
